...
let nowNumbs = strNumbs.map(numbs => parseInt(numbs))

// console.log(nowNumbs)

// With the same numbers, find the sum of the even values
const sumEvens = nowNumbs.reduce((acc, nextNum) => {
  // console.log(`your next number is :`, nextNum )
    if (nextNum % 2 === 0) {
      // console.log(nextNum)
      acc += nextNum
    }
...
//go through the weather array and locate each element called weather_state_name
//make a new array of each of these elements 
const weatherStates = weather.map((objects) => {
...
//look at the min_temp 
  //if the temp is 15.915
