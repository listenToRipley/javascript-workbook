...
let bothTrue = document.getElementById('bothTrue')
...
let trueFalse = document.getElementById('oneTrue')

trueFalse.innerHTML = oneTrue

//when both things are not true.
let twoFalse = truthy(notTrue, iLied)

let bothFalse = document.getElementById('bothFalse')

bothTrue.innerHTML = twoFalse
